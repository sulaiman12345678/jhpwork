...
<body class="bg-light">
			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="ธีรณัฐ มหัทธโนบล" class="rounded-circle shadow" width="140" height="140" src="assets/img/sulaiman.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>สุไลมาน หะมะ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010038</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/OungOungbabs" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Sulaiman</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="อาสูรา สาเมาะ" class="rounded-circle shadow" width="140" height="140" src="assets/img/rohman.jpg" />
						<h5 class="pt-4 mb-3">ผู้ช่วยพัฒนาระบบ</h5>
						<h2>อับดุลเราะมาน เส็นสอ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010042</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/abdurohman.sensoe?ref=bookmarks" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Abdulrohman</a></p>
					</div>
					<div class="col-lg-4 pb-4">
	...
	<p class="mt-4 small text-muted text-center">&copy; 2019 Anak Patani</p>
